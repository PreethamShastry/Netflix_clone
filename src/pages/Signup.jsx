           ...
           <div className='fixed w-full px-4 py-24 z-20'>
            <div className='max-w-[450px] h-[500px] mx-auto bg-black/60 rounded-lg'>
              <div className='max-w-[320px] mx-auto py-16'>
                  <h1 className='text-3xl font-snaserif text-center'>Sign up</h1>
                    <form onSubmit={handleFormSubmit} className='w-full flex flex-col py-4'>
                      ...
                      <button className='bg-red-600 p-3 my-6 rounded font-snaserif'>Sign up</button>
                      ...
                      <p className='my-4'>
                        <span>Already subcribed to Netfilx?</span>
                        <Link className='text-blue-800 p-1' to="/login">Login</Link>
                      </p>
